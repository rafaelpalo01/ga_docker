...
const EditCourse = ({ course }) => {
    ...
    const updateCourse = async () => {
        try {
            const res = await fetch(`https://dockeractionsrdp.azurewebsites.net/api/civilcourse/${router.query.id}`, {
                method: 'PUT',
                headers: {
...
EditCourse.getInitialProps = async ({ query: { id } }) => {
    const res = await fetch(`https://dockeractionsrdp.azurewebsites.net/api/civilcourse/${id}`);
